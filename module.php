...
function widget_search($title){ ?>
	...
	<input type="text" name="keyword" class="search-form-input" placeholder="请输入关键字" autocomplete="off">
...
function blog_navi(){
	...
	<nav class="navbar navbar-fixed-top col-xs-12 col-sm-12 col-md-10 col-md-offset-1">
	...
	<?php else: ?>
	<a href="<?php echo BLOG_URL; ?>admin/" target="_blank">登录</a></div>
	<?php endif; ?>
	</nav>
<?php }?>
<?php
...
function topflg($top, $sortop='n', $sortid=null){
    if(blog_tool_ishome()) {
       echo $top == 'y' ? "<img src=\"".TEMPLATE_URL."/images/hot.gif\" title=\"首页置顶文章\" /> " : '';
    } elseif($sortid){
       echo $sortop == 'y' ? "<img src=\"".TEMPLATE_URL."/images/hot.gif\" title=\"分类置顶文章\" /> " : '';
    }
}
?>
<?php
